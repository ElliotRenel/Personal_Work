...
/**
 * @brief The structure pointer that stores the directions and pieces as tabs of height*width size
 **/
...
/**
 * @brief Tests if a boolean tab only has true values
 * @param t the boolean tab
...
/**
 * @brief Test if node on the (x,y) position has an edge in given direction
 * @param g the game used
 * @param x the x coordinate of the node
 * @param y the y coordinate of the node
 * @param dir the direction in which to test
 * @return true if all the constraints are satisfied
 **/
bool on_edge(cgame g, int x, int y, direction dir);

/**
 * @brief Change value of x and y to the position of the nearest node in given direction
 * @param g the game we consider
 * @param x the current x coordinate
 * @param y the current y coordinate
 * @param dir the direction where the next node is
 **/
void near_node(cgame g, int* x, int* y, direction dir);

/**
 * @brief Check if all pieces of given game are connected to one another with no piece having an empty connexion 
...
/**
 * @brief Give the number of nodes in given game
 * @param g the game we consider
...
/**
 * @brief Check if the game doesn't contains loop by traveling from node to node and checking if we see an already seen node
 * @param g the game we consider
 * @param x the x coordinate from where you start the recurrence
 * @param y the y coordinate from where you start the recurrence
 * @param mark a boolean tab initialized with only false used to check where the function went in the game
 * @param origin the direction from wich we come from in the recurrence
 * @return true if all the constraints are satisfied
 **/
