...
/**
 * @brief The structure pointer that stores the directions and pieces
 **/

typedef struct uni_s* uni;
...
game new_game(piece *pieces, direction *initial_directions); // test: Elliot
...
void set_piece(game g, int x, int y, piece piece, direction orientation); // test: Frederic
...
void shuffle_dir(game g);  // test: Elliot
...
int game_height(cgame game); // test: Théo
...
int game_width(cgame game); // test: Frederic
...
void rotate_piece_one(game game, int x, int y); // test: Frederic
...
void rotate_piece(game game, int x, int y, int nb_cw_quarter_turn); // test: Frederic
 ...
 **/
void set_piece_current_dir (game game, int x, int y, direction dir); // test: Elliot
...
bool is_edge_coordinates(cgame g, int x, int y, direction dir); // test: Elliot
...
bool is_edge(piece piece, direction orientation, direction dir); // test: Elliot
...
direction opposite_dir(direction dir); // test: Theo
 ...
 **/
game copy_game (cgame g_src); // test: Theo
 ...
 **/
void delete_game (game g); // test: Théo
...
piece get_piece(cgame game, int x, int y); // test: Frederic
...
direction get_current_dir(cgame g, int x, int y); // test: Théo
...
bool is_game_over (cgame g); // test: Elliot
